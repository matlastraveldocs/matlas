...
$sections = array(
	'courses'      => esc_html__( 'Courses' ),
	'lessons'      => esc_html__( 'Lessons' ),
	'topic'        => esc_html__( 'Topics' ),
	'quiz'         => esc_html__( 'Quizzes' ),
	'question'     => esc_html__( 'Questions' ),
	'certificates' => esc_html__( 'Certificates' ),
	'assignment'   => esc_html__( 'Assignments' ),
);
