	...
	public function layouts( $layout ) {
		...
		foreach( $types as $type ) {
			...
			if ( is_post_type_archive( $type ) ) {
				return wpex_get_mod( $type . '_archives_layout', wpex_get_mod( 'learndash_layout' ), true );
			}

			// Single posts
			if ( is_singular( $type ) ) {
				return wpex_get_mod( $type . '_single_layout', wpex_get_mod( 'learndash_layout' ), true );
			}
