						...
						if ( $entry_has_details ) {
							...
							$output .= '>';
								...
								if ( 'true' == $title ) {
									...
									$title_output .= '<' . $title_tag_escaped . ' class="vcex-blog-entry-title entry-title"' . $heading_style . '><a href="' . $latts['post_permalink'] . '"' . $url_target . $heading_link_style . '>' . wp_kses_post( $latts['post_title'] ) . '</a></' . $title_tag_escaped . '>';
